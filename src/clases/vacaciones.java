...
public class vacaciones {
	...
	public Date getFecha_inicio_v() {
		return fecha_inicio_v;
	}
	public void setFecha_inicio_v(Date fecha_inicio_v) {
		this.fecha_inicio_v = fecha_inicio_v;
	}
	public Date getFecha_finalizacion_v() {
		return fecha_finalizacion_v;
	}
	public void setFecha_finalizacion_v(Date fecha_finalizacion_v) {
		this.fecha_finalizacion_v = fecha_finalizacion_v;
	}
