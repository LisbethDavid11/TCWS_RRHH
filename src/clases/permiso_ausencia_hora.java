...
public class permiso_ausencia_hora {
	...
	public String getCargo_recibe() {
		return cargo_recibe;
	}
	public void setCargo_recibe(String cargo_recibe) {
	...
	public void setCargo_extiende(String cargo_extiende) {
		this.cargo_extiende = cargo_extiende;
	}
