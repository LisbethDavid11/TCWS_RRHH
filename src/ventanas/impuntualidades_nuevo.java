...
public class impuntualidades_nuevo extends JFrame {
    ...
    public impuntualidades_nuevo() {
        ...
        JLabel lblIncapacidadLaboral = new JLabel("DATOS DE LA IMPUNTUALIDAD");
        ...
        btnregresar.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		impuntualidades_tabla tabla = new impuntualidades_tabla();
        ...
        txamotivo.addKeyListener(new KeyAdapter() {
        	...
        	public void keyTyped(KeyEvent e) {
        		validaciones.validarLongitud(e, txamotivo, 300);        	
        ...
        JLabel lblPresuncinDeRiesgo = new JLabel("Motivo de la impuntualidad");
        ...
        JLabel lblHoraDeExpedicin = new JLabel("Fecha de la impuntualidad");
        lblHoraDeExpedicin.setFont(new Font("Tahoma", Font.BOLD, 15));
        lblHoraDeExpedicin.setBounds(384, 311, 211, 25);
        ...
        JLabel lbldesde_1_1 = new JLabel("Hora de marcada");
        lbldesde_1_1.setFont(new Font("Tahoma", Font.BOLD, 15));
        lbldesde_1_1.setBounds(668, 379, 200, 25);
