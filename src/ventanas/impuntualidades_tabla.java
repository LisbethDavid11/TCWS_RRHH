...
public class impuntualidades_tabla extends JFrame {
    ...
    public impuntualidades_tabla() {
        ...
        btnnuevo.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                impuntualidades_nuevo nuevo = new impuntualidades_nuevo();
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (filaSeleccionada == -1) {
                    JOptionPane.showMessageDialog(null,
                        "Debe seleccionar una fila antes de generar el reporte.",
                        "Advertencia", JOptionPane.WARNING_MESSAGE);
                    return;
                }

                int filaModelo = table.convertRowIndexToModel(filaSeleccionada);
                String nombre = table.getModel().getValueAt(filaModelo, 3).toString().trim();
                String apellido = table.getModel().getValueAt(filaModelo, 4).toString().trim();

                try {
                    reportes.reporte_impuntualidades rep = new reportes.reporte_impuntualidades();
                    rep.generarReporteNarrativo(table, filaModelo, nombre, apellido);
                } catch (Exception ex) {
                    ex.printStackTrace();
                    JOptionPane.showMessageDialog(null,
        ...
        btnimprimir.setToolTipText("Eliminar registro");
        btnimprimir.setFont(new Font("Tahoma", Font.BOLD, 10));
        btnimprimir.setBounds(151, 18, 90, 23);
        panelbotones.add(btnimprimir);

        JLabel lblPermisosAusenciaLaboral = new JLabel("IMPUNTUALIDADES");
    ...
    private void pasarDatosAlFormulario(int fila) {
        ...
        impuntualidades_nuevo formulario = new impuntualidades_nuevo();
